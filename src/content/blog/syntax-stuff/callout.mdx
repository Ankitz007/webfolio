...
description: 'Learn how to use the Callout component.'
date: 2025-08-28
tags: ['syntax']
authors: ['ankitz007']
order: 4
...
You can even have a custom callout with a custom title and no variant specified:

```mdx showLineNumbers=false 'variant' 'customLabel'
<Callout variant="custom" customLabel="Fun Fact" title="Custom callout">
  This is a custom callout. Have fun!
</Callout>
```
...
The following is a custom callout without a title.

```mdx showLineNumbers=false
<Callout variant="custom" customLabel="Did you know?">
  This is a custom callout without a title.
</Callout>
```
